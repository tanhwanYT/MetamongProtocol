...
public class Gen_970a191d_accf_40b7_8055_382eafdc23b7 : MonoBehaviour
{
    // === User Variables ===
    ...
    void Update()
    {
        ...
        float pulse = Mathf.Lerp(0.9f, 1.1f, (Mathf.Sin(Time.time * 2f) + 1f) / 2f);
        _transform.localScale = new Vector3(pulse, pulse, 1f);
    }
